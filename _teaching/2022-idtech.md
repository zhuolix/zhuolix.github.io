...
- Topics covered for atmospheric vehicles:
    ...
    - Objective-oriented, modularized vehicle design (reuse of base crafts, payload planning);
    - Flight operations (airfield traffic patterns, principles of air combat);